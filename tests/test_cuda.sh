...
cd ..
LibDDLA_PATH="${PWD}_install_test"
cd tests
...
mpicxx -g -O2 -lcudart -lddla -fopenmp -lcublas -lcusolver -lcurand -lcal -lcusolverMp ${FILENAME}.cpp -o ${FILENAME} -std=c++11 -DENABLE_CUDA -DENABLE_CCL
